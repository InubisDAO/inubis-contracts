...
contract InubisAuthorityTest is DSTest {
    InubisAuthority authority;
    ...
    function test_onlyGovernor_not_authorized() public {
        authority = new InubisAuthority(UNAUTHORIZED_USER, address(this), address(this), address(this));
    ...
    function test_onlyGuardian_not_authorized() public {
        authority = new InubisAuthority(address(this), UNAUTHORIZED_USER, address(this), address(this));
        accessControlledMock = new AccessControlledMock(address(authority));
    ...
    function test_onlyPolicy_not_authorized() public {
        authority = new InubisAuthority(address(this), address(this), UNAUTHORIZED_USER, address(this));
        accessControlledMock = new AccessControlledMock(address(authority));
    ...
    // TODO create tests for push/pull mechanism within InubisAuthority
