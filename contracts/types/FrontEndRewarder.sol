...
abstract contract FrontEndRewarder is InubisAccessControlled {
    /* ========= STATE VARIABLES ========== */
    ...
    IERC20 internal immutable inkh; // reward token

    constructor(IInubisAuthority _authority, IERC20 _inkh) InubisAccessControlled(_authority) {
        inkh = _inkh;
    }
    ...
    function getReward() external {
        ...
        inkh.transfer(msg.sender, reward);
    }
