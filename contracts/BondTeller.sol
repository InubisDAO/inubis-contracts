...
contract BondTeller is ITeller, InubisAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    struct Bond {
        ...
        uint256 payout; // sINKH remaining to be paid. agnostic balance
    ...
    IERC20 internal immutable INKH;
    IsINKH internal immutable sINKH; // payment token
    ...
    function newBond(
        ...
        INKH.approve(address(staking), _payout);
    ...
    function getReward() external override {
        ...
        FERs[msg.sender] = 0;
        INKH.safeTransfer(msg.sender, reward);
    }
    ...
    function pay(address _bonder, uint256 _amount) internal {
        sINKH.safeTransfer(_bonder, _amount);
    }
    ...
    /**
     * @notice calculate amount of INKH available for claim for single bond
     * @param _bonder address
    ...
    /**
     * @notice calculate amount of INKH available for claim for array of bonds
     * @param _bonder address
