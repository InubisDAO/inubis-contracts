...
/**
 * A mock version of sINKH, with an over-simplified rebase mechanism, for testing purposes only
 */
contract MockSINKH is ERC20 {
    ...
    constructor(uint256 initialIndex_, uint256 rebasePct_) ERC20("Mock sINKH", "sINKH") {
