...
/// @title Inubis Bond Depository V2

contract InubisBondDepositoryV2 is IBondDepository, NoteKeeper {
    /* ======== DEPENDENCIES ======== */
    ...
    constructor(
        IInubisAuthority _authority,
        IERC20 _inkh,
        IgINKH _ginkh,
        IStaking _staking,
        ITreasury _treasury
    ) NoteKeeper(_authority, _inkh, _ginkh, _staking, _treasury) {
        // save gas for users by bulk approving stake() transactions
        _inkh.approve(address(_staking), 1e45);
    }
     ...
     * @return payout_     the amount of gINKH due
        ...
        )
    {
         ...
         * price = quote tokens : inkh (i.e. 42069 DAI : INKH)
         *
         * 1e18 = INKH decimals (9) + price decimals (9)
         */
         ...
         *
         * this is either the number of INKH that the market can sell
        ...
        // purchased, and how much INKH has been sold
    ...
    function _tune(uint256 _id, uint48 _time) internal {
        ...
        if (_time >= meta.lastTune + meta.tuneInterval) {
            ...
            // inkh decimals (9) + price decimals (9)
             ...
             * is 10,000 INKH. max payout would be 1,000 INKH (10,000 * 1 / 10).
             */
     ...
     * @param _market      [capacity (in INKH or quote), initial price / INKH (9 decimals), debt buffer (3 decimals)]
    ...
    function create(
         ...
         *
         * 1e18 = inkh decimals (9) + initial price decimals (9)
         */
        uint64 targetDebt = uint64(_booleans[0] ? ((_market[0] * 1e18) / _market[1]) / 10**decimals : _market[0]);

        /*
         * max payout is the amount of capacity that should be utilized in a deposit
         * interval. for example, if capacity is 1,000 INKH, there are 10 days to conclusion,
         * and the preferred deposit interval is 1 day, max payout would be 100 INKH.
         */
        ...
        emit CreateMarket(id_, address(inkh), address(_quoteToken), _market[1]);
    }
     ...
     * @param _id          ID of market
     * @return             price for market in INKH decimals
     *
     ...
     * @param _id          ID of market
     * @return             amount of INKH to be paid in INKH decimals
     *
     * @dev 1e18 = inkh decimals (9) + market price decimals (9)
     */
     ...
     * @param _id          ID of market
     * @return             current debt for market in INKH decimals
     */
     ...
     * @param _id          ID of market
     * @return             control variable for market in INKH decimals
     */
