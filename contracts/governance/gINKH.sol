...
contract gINKH is IgINKH, ERC20 {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(address _migrator, address _sINKH) ERC20("Governance INKH", "gINKH", 18) {
     ...
     * @param _sINKH address
     */
    function migrate(address _staking, address _sINKH) external override onlyApproved {
        ...
        require(_sINKH != address(0), "Zero address found");
        sINKH = IsINKH(_sINKH);
    }
    ...
    /**
     * @notice pull index from sINKH token
     */
    ...
    /**
        @notice converts gINKH amount to INKH
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts INKH amount to gINKH
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gINKH::getPriorVotes: not yet determined");
