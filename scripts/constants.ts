export const CONTRACTS: Record<string, string> = {
    inkh: "InubisERC20Token",
    sInkh: "sInubis",
    gInkh: "gINKH",
    staking: "InubisStaking",
    distributor: "Distributor",
    treasury: "InubisTreasury",
    bondDepo: "InubisBondDepository",
    teller: "BondTeller",
    bondingCalculator: "InubisBondingCalculator",
    authority: "InubisAuthority",
    migrator: "InubisTokenMigrator",
    FRAX: "Frax",
    DAI: "DAI",
